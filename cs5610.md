...
Web technologies move so fast that good books on the subject are quickly get out of date.
Therefore, reading for this course will come mostly from [MDN](https://developer.mozilla.org/en-US/),
which has become authoritative documentation for the web technologies that we'll use.
