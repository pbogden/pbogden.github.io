...
| 10   | Unsupervised Learning         | § 12.1-2, § 12.4            | § 5.11 (K-means) |
| 11   | Nonlinearity (Trees/SVMs)     | § 8.1-2, § 9.1-3 (optional) | § 5.07-8 (Random Forest, SVMs) |
| 12   | Text Mining                   | ---                         | § 5.04-5  (feature engineering & naive Bayes) |
| 13   | Project Presentations         | ---                         | --     |

* Modules include case studies with data sources ranging from tabular and relational data to images and text.
* Each module involves selected readings from ISL and PDS, with occasional reading from other sources.
