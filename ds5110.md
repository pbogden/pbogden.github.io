...
* Weekly modules provide context and analytic goals for case studies that involve the entire data-processing pipeline.
* Weekly concept modules loosely follow the chapter progression in ISL. PDS implementations complement the ISL reading.
...
* Lecture -- Lectures provide context for in-class exercises and will comprise a fraction of total class time.
