...
* Topics include case studies with data sources ranging from tabular and relational data to images and text.
* Each topic involves selected readings from ISL and PDS, with occasional reading from other sources.
