...
* **Github**: Assignment submissions -- you'll be invited to github classroom using your northeastern.edu email
...
* ISL: [Introduction to Statistical Learning with Applications in R/Python, 2nd Ed](http://statlearning.com) (2021) by Gareth James, Daniela Witten, Trevor Hastie and Rob Tibshirani (and Jonathan Taylor for the Python version).
  ...
  * Each chapter has labs in R or Python that are independent of the concept sections.
  * Selected readings from this text will be assigned weekly.
...
* Additional online reading will for materials on SQL and relational databases.
...
* Projects -- Small groups (2-3 students) will work collaboratively on a practical, stakeholder-driven project.
